...
## Основные правила
1. Использовать CTE для подзапросов.
2. Для доступа к наиболее актуальной документации по ClickHouse используй mcp-сервер context7.
...
## Рекомендации
- При работе с ClickHouse использовать CTE для улучшения читаемости запросов.
